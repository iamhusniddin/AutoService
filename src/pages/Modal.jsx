...
function Modal({children, setOpenModal}) {
  ...
  return (
    <div onClick={handleCloseModal} className='absolute top-0 z-100 p-2 sm:p-0 left-0 w-full h-screen overlay cursor-context-menu flex justify-center items-center  overflow-y-auto bg-black/40'>
