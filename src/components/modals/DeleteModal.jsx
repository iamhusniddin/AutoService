...
function DeleteModal({handleDeleteConfirm, setDeleteModal, selectedProductName }) {
  ...
  return (
    <div onClick={handleCloseMOdal} className='absolute top-0 z-100 left-0 p-2 sm:p-0 w-full h-screen overlay cursor-context-menu flex justify-center items-center   bg-black/20'>
        <div className='relative rounded-lg shadow p-3 bg-white'>
            ...
            <div className="p-4 md:p-5 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 ">{selectedProductName ? selectedProductName : 'Ushbu tovar'}ni o'chirishga ishonchingiz komilmi?</h3>
